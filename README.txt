...
An acceptor accepts two kind of requests from leaders: SolicitateBallot and RequestVote.
...
When a leader is elected, he can organize a vote.
...
When a leader loses an election because its ballot is too low, he gets the last up to date highest ballot number from acceptors which give him more chance to win the next election.
He will also retry not instantly to avoid to have an infinite loop of a leader getting the highest ballot from another leader before it ends the vote.
